...
view : view represents the user interface of the app,it ahows the modelled data and taking inputs from the user
Controller : the controller mostly consist of some business logics, that is what will be displayed to user , also handling user input.
...
JSX is a javascript extension and  is used to crate react elements.
